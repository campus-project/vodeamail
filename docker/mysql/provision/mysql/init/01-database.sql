...
CREATE DATABASE IF NOT EXISTS `vodeamail-auth-service` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE DATABASE IF NOT EXISTS `vodeamail-audit-service` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
